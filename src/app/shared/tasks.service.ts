...
export class TasksService {
  static url = 'https://angular-organizer-7efa7-default-rtdb.europe-west1.firebasedatabase.app/tasks'
  ...
  load(date: moment.Moment): Observable<Task[]> {
    return this.http
      ...
      .pipe(map(tasks => {
        ...
        console.log(Object.keys(tasks).map(key => ({...tasks[<any>key], id: key})))
